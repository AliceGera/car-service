...
enum AppTextStyle {
  ...
  regular28(TextStyle(fontSize: 28, height: 1.6, fontWeight: FontWeight.w400, fontFamily: 'Raleway')),
  regular15(TextStyle(fontSize: 15, height: 1.95, fontWeight: FontWeight.w400, fontFamily: 'Roboto')),
